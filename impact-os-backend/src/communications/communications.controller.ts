...
import { CommunicationsService, CommunicationStats, CommunicationLogItem, PaginatedResponse } from './communications.service';
...
export class CommunicationsController {
    ...
    async previewSegment(@Body() segment: {
    ...
    async getSegmentRecipients(@Body() segment: {
        type: 'all' | 'cohort' | 'phase' | 'custom';
        cohortId?: string;
        phase?: string;
        customIds?: string[];
