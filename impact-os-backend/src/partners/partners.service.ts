  ...
  async submitInquiry(dto: SubmitPartnerInquiryDto) {
    ...
    if (isSponsor) {
      ...
      return {
        ...
        type: 'sponsor',
        message:
          'Thank you for your interest in sponsoring! Our team will reach out within 24 hours.',
      };
    } else {
      ...
      return {
        ...
        type: 'partner',
        message:
          'Thank you for your partnership interest! Our team will be in touch soon.',
      };
    }
  }
