  ...
  async getActiveConfig() {
    ...
    if (!activeCohort || !activeCohort.config) {
      ...
      return {
        ...
        founderMessageBody:
          "I'm so excited to have you join us. You've taken the first step toward transforming your future. Check your email for next steps, and remember: every expert was once a beginner.",
        founderName: 'Pope',
    ...
    return {
      ...
      founderImageUrl:
        activeCohort.config.founderImageUrl || '/images/Pope.png',
      founderSignatureUrl:
        activeCohort.config.founderSignatureUrl || '/images/sig.png',
